...
{
  const {settings, user, express, remoteApi, User} = module;
  ...
  const redirectToRemoteApi = remoteApi.createRedirect({responseHandler: handleLoginResponse});
  ...
  express.get('/users', canBrowse, redirectToRemoteApi, express.crud.browseRoute.bind(null, app, User));
  express.post(
    '/users',
    canManage,
    redirectToRemoteApi,
